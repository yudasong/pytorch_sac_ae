...
def main():
    ...
    for step in range(args.num_train_steps):
        expert_agent.post_update_critic(expert_replay_buffer, expert_replay_buffer,step)

        if step % 10000 == 0:
            print(step)
                
    expert_agent.save_post_critics(args.expert_dir, step)
